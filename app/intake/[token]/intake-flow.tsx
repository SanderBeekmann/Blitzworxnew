        ...
        {step === 'welcome' && session && (
          <div className="flex flex-col items-center text-center py-12">
            ...
            <p className="text-dry-sage max-w-md leading-relaxed mb-8">
              Bedankt voor je contact! Ik kijk er naar uit om met elkaar in gesprek te gaan. Voordat we elkaar spreken zou ik graag nog wat meer informatie willen om een zo goed mogelijke start van het project te realiseren. Alvast bedankt en tot snel!
            </p>
